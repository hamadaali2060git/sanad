...
@if(!Route::is(['instructor-login','register','forgot-password','lock-screen','error-404','error-500']))

<body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar chat-application"
	...
	<nav
		...
		<div class="navbar-wrapper">
			@include('layout.instructor.nav')
		</div>
	</nav>

	<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
		@include('layout.instructor.sidbar')
	</div>
	@endif
