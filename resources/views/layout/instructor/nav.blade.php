  ...
  if($useridd){
        ...
        foreach ($not as $item) {
            ...
            $notifications= Instructor::with(array('unreadnotifications'=>function($query){
                    $useridd = Auth::guard('instructors')->user();
                    $query->where('notifiable_id',$useridd->id);
            }))->get();
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="#">
              ...
              <h3 class="brand-text">  لوحة تحكم المدرب</h3>
            </a>
          </li>
        ...
        <div class="collapse navbar-collapse" id="navbar-mobile">
          <ul class="nav navbar-nav mr-auto float-left">
           ...
           <a href="{{url('/')}}" title="" class="logo">
                    ...
                    <img src="{{asset('assets_admin/img/settings/'.$contact->logo) }}" width="140px">
                </a>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <span class="avatar avatar-online">
                  ...
                  <img src="{{asset('admin/images/portrait/small/avatar-s-19.png')}}" alt="avatar"><i></i></span>
              </a>
                      ...
                      <!--<a href="{{url('view/notification/'.$_item->id)}}">-->
                        <div class="media">
                          <div class="media-left align-self-center">
                            <!--@if($_item->photo !=null)-->
                            <!--  <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('img/profiles//'.$_item->photo) }}" width="50px">-->
                            <!--@else                                      -->
                            <!--  <img class="avatar-img rounded-circle" alt="User Image" src="{{asset('assets_admin/img/profile_image.png') }}" width="50px">-->
                            <!--@endif-->

                            <!-- <i class="ft-plus-square icon-bg-circle bg-cyan"></i> -->
                          </div>
                          <div class="media-body">
                            <!--<h6 class="media-heading"> تم الاشتراك من {{$_item->name}}</h6>-->
                            <p class="notification-text font-small-3 text-muted">{{$_items->data['message']}}:</p>
                            <small>
