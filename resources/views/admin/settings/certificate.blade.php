...
<!--  <section id="basic">
		...
		<div class="content-header row">
			        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
			          <h3 class="content-header-title mb-0 d-inline-block">سعر الشهادة</h3><br>
			          <div class="row breadcrumbs-top d-inline-block">
			            <div class="breadcrumb-wrapper col-12">
			              <ol class="breadcrumb">
			                ...
			                <li class="breadcrumb-item active">سعر الشهادة
			                </li>
			              </ol> 
			            </div>
			          </div>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                   	<div class="card-body">
										<form action="{{url('admin/certificate_price/update')}}" method="POST" name="le_form"  enctype="multipart/form-data">
								                                @csrf
											<input type="hidden" name="id" value="{{Auth::user()->id}}">
																					
											<div class="form-group">
												<label>سعر شهادة الكورسات المسجلة</label>
												<input type="number" name="certificate_price" class="form-control" value="{{$contactInfo->certificate_price}}">
											</div>
											<div class="form-group">
												<label>سعر شهادة الكورسات التفاعلية</label>
												<input type="number" name="live_certificate" class="form-control" value="{{$contactInfo->live_certificate}}">
											</div>
