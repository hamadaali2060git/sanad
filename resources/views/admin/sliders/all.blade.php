												...
												<tr>
													<td>
														<a href="profile" class=" mr-2">
															<img class="avatar-img" src="{{asset('img/sliders/'.$_item->image) }}" alt="Speciality" width="100px">
														</a>
													</td>
													<td>
														{{ $_item->title_ar }}
													...
													<td class="text-right">
				                                        ...
				                                        <a  data-toggle="modal" data-catid="{{ $_item->id }}" data-target="#delete{{$_item->id}}" class="btn btn-sm bg-danger-light delete-course">
                                    								...
                                    								<div class="row form-row">
                                    									...
                                    									<div class="col-12 col-sm-6">
                                    										<div class="form-group">
                                    											...
                                    											<input type="text" name="title_ar" class="form-control" value="{{$_item->title_ar}}">
                                    										</div>
                                    									</div>
                                    									<div class="col-12 col-sm-6">
                                    										<div class="form-group">
                                    											<label>العنوان انجليزي</label>
                                    											<input type="text" name="title_en" class="form-control" value="{{$_item->title_en}}">
                                    										</div>
                                    									</div>
                                    									<div class="col-12 col-sm-6">
                                    										<div class="form-group">
                                    											<label>الوصف عربي</label>
                                    											<input type="text" name="description_ar" class="form-control" value="{{$_item->description_ar}}">
                                    										</div>
                                    									</div>
                                    									<div class="col-12 col-sm-6">
                                    										<div class="form-group">
                                    											<label>الوصف انجليزي</label>
                                    											<input type="text" name="description_en" class="form-control" value="{{$_item->description_en}}">
                                    										</div>
                                    									</div>
