                ...
                <table class="table table-striped table-bordered keytable-integration">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $_item->title }}</td>
                      <td>
                        <a href="{{url('admin/instructor-profile/'.$_item->course_instructor->id) }}">{{
                          $_item->course_instructor->name }}</a>
                      </td>
                      <td>
                        <a data-toggle="modal" data-catid="{{ $_item->id }}" data-target="#status{{$key}}"
                          class="delete-course">
                                          ...
                                          <div class="card-body" style="text-align: right;">
                                            <fieldset>
                                              <div class="float-left">
                                                <input type="radio" name="status" class="switchBootstrap" value="1" {{
                                                  $_item->status == 1 ? 'checked' : '' }}>
                                                <label>مقبولة</label>
                                                <br>
                                                <input type="radio" name="status" class="switchBootstrap" value="0" {{
                                                  $_item->status == 0 ? 'checked' : '' }}>
                                                <label>بانتظار الموافقة</label>
                                                <br>
                                                <input type="radio" name="status" class="switchBootstrap" value="2" {{
                                                  $_item->status == 2 ? 'checked' : '' }}>
                                                <label>بحاجة إلى تغيير الوقت</label>
                                                <br>
                                                <input type="radio" name="status" class="switchBootstrap" value="3" {{
                                                  $_item->status == 3 ? 'checked' : '' }}>
                                                <label> بحاجة الى تأجيل الموعد </label>
                                                <br>
                                                <input type="radio" name="status" class="switchBootstrap" value="4" {{
                                                  $_item->status == 4 ? 'checked' : '' }}>
                                                <label>يرجى التواصل معنا</label>
                                                <br>
                                                <input type="radio" name="status" class="switchBootstrap" value="5" {{
                                                  $_item->status == 5 ? 'checked' : '' }}>
                                                <label>أنتهت</label>
                                                <br>
                                              </div>
                                            </fieldset>
